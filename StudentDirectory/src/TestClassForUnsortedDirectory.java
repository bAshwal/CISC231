 ...
 * 
 *TestClassForUnsortedDirectory: Run test cases for UnsortedDirectory class
 * 
 */
import java.util.Random;

public class TestClassForUnsortedDirectory {

	public static void main(String[] args) {
		
		UnsortedDirectory d1 = new UnsortedDirectory();
		
		System.out.println("======================================");
		System.out.println("    Testing UnsortedDirectory Class     ");
		System.out.println("======================================");
		...
		d1.addStudent("Mary", 100000007);
		d1.addStudent("Gary", 100000011);
		d1.addStudent("Gary", 100000006);
		d1.addStudent("Gary", 100000005);
		d1.addStudent("Gary", 100000004);
		...
		// Adding 20 students to test dynamicity and sorting of the list
		...
		// Removing, adding, and looking up students in the directory
		System.out.println("*Test Case8: Removing {Mark,100000009}, adding {Bakr,123123123}, & lookingup {Mary,100000007}");
		d1.removeStudent(100000009);
		System.out.println("*1) {Mark,100000009}removed.");
		System.out.println(d1.prettyStr());
		System.out.println("*2) {Bakr,123123123}added.");
		d1.addStudent("Bakr", 123123123);
		System.out.println(d1.prettyStr());
